from PyQt6.QtWidgets import QMainWindow, QMenuBar, QMdiArea, QStackedWidget, QDockWidget
from PyQt6.QtWidgets import QStatusBar, QMessageBox, QProgressDialog, QDialog, QLabel
